...
sudo service unicorn_RailsStarter <start|stop|restart>
sudo service sidekiq_RailsStarter <start|stop>
```
...
```
/home/deployer/apps/RailsStarter/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_RailsStarter restart
sudo service sidekiq_RailsStarter stop
sudo service sidekiq_RailsStarter start
```
